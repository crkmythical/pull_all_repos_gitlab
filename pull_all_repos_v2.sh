...
# 让脚本进程成为新的进程组组长，方便统一信号管理和kill子进程
...
Options:
  -t    GitLab Private Token (required)
  -u    GitLab URL (default: https://gitlab.com)
  -d    Clone base directory (default: ./gitlab_repos)
  -g    Max concurrent groups cloning (default: 3)
  -r    Max concurrent repos cloning per group (default: 5)
  -h    Show this help message and exit

Example:
  $0 -t glpat_xxx -u https://gitlab.example.com -d /tmp/repos -g 2 -r 4
EOF
  exit 1
}
