...
Alternatively, you can export your token via environment variable:

  export GITLAB_ACCESS_TOKEN=yourtoken
  $0 -u https://gitlab.company.com
EOF
  exit 1
}
...
# 新增：优先用 -t 参数，否则用环境变量 GITLAB_ACCESS_TOKEN
GITLAB_TOKEN="${GITLAB_TOKEN:-$GITLAB_ACCESS_TOKEN}"
